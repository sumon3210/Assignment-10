            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-slate-50 dark:bg-slate-950 focus:bg-white text-sm rounded-xl border border-slate-200 dark:border-slate-800 focus:border-emerald-500 pr-10 focus:outline-none transition-all text-slate-850 dark:text-slate-150"
                />

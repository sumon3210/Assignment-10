...
import { Mail, Lock, LogIn, ArrowRight, Chrome, ShieldAlert, Sparkles } from "lucide-react";
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-slate-50 dark:bg-slate-950 focus:bg-white text-sm rounded-xl border border-slate-200 dark:border-slate-800 focus:border-emerald-500 dark:focus:border-emerald-550 focus:outline-none transition-all text-slate-850 dark:text-slate-150"
                />
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-slate-50 dark:bg-slate-950 focus:bg-white text-sm rounded-xl border border-slate-200 dark:border-slate-800 focus:border-emerald-500 dark:focus:border-emerald-550 focus:outline-none transition-all text-slate-850 dark:text-slate-150"
                />
                <Lock className="absolute left-4 top-3.5 w-4.5 h-4.5 text-slate-405 text-slate-400" />
              </div>
            </div>
